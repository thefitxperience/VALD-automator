 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(C,N){var O=C.length;C.push(N);e:for(;0<O;){var I=O-1>>>1,H=C[I];if(0<a(H,N))C[I]=N,C[O]=H,O=I;else break e}}function t(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var N=C[0],O=C.pop();if(O!==N){C[0]=O;e:for(var I=0,H=C.length,xe=H>>>1;I<xe;){var X=2*(I+1)-1,Pe=C[X],un=X+1,We=C[un];if(0>a(Pe,O))un<H&&0>a(We,Pe)?(C[I]=We,C[un]=O,I=un):(C[I]=Pe,C[X]=O,I=X);else if(un<H&&0>a(We,O))C[I]=We,C[un]=O,I=un;else break e}}return N}function a(C,N){var O=C.sortIndex-N.sortIndex;return O!==0?O:C.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var s=[],u=[],d=1,p=null,m=3,w=!1,g=!1,y=!1,S=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(C){for(var N=t(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=C)r(u),N.sortIndex=N.expirationTime,n(s,N);else break;N=t(u)}}function v(C){if(y=!1,h(C),!g)if(t(s)!==null)g=!0,G(k);else{var N=t(u);N!==null&&Ae(v,N.startTime-C)}}function k(C,N){g=!1,y&&(y=!1,x(L),L=-1),w=!0;var O=m;try{for(h(N),p=t(s);p!==null&&(!(p.expirationTime>N)||C&&!W());){var I=p.callback;if(typeof I=="function"){p.callback=null,m=p.priorityLevel;var H=I(p.expirationTime<=N);N=e.unstable_now(),typeof H=="function"?p.callback=H:p===t(s)&&r(s),h(N)}else r(s);p=t(s)}if(p!==null)var xe=!0;else{var X=t(u);X!==null&&Ae(v,X.startTime-N),xe=!1}return xe}finally{p=null,m=O,w=!1}}var R=!1,_=null,L=-1,A=5,P=-1;function W(){return!(e.unstable_now()-P<A)}function pe(){if(_!==null){var C=e.unstable_now();P=C;var N=!0;try{N=_(!0,C)}finally{N?V():(R=!1,_=null)}}else R=!1}var V;if(typeof f=="function")V=function(){f(pe)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,le=z.port2;z.port1.onmessage=pe,V=function(){le.postMessage(null)}}else V=function(){S(pe,0)};function G(C){_=C,R||(R=!0,V())}function Ae(C,N){L=S(function(){C(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){g||w||(g=!0,G(k))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(C){switch(m){case 1:case 2:case 3:var N=3;break;default:N=m}var O=m;m=N;try{return C()}finally{m=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,N){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var O=m;m=C;try{return N()}finally{m=O}},e.unstable_scheduleCallback=function(C,N,O){var I=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?I+O:I):O=I,C){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=O+H,C={id:d++,callback:N,priorityLevel:C,startTime:O,expirationTime:H,sortIndex:-1},O>I?(C.sortIndex=O,n(u,C),t(s)===null&&C===t(u)&&(y?(x(L),L=-1):y=!0,Ae(v,O-I))):(C.sortIndex=H,n(s,C),g||w||(g=!0,G(k))),C},e.unstable_shouldYield=W,e.unstable_wrapCallback=function(C){var N=m;return function(){var O=m;m=N;try{return C.apply(this,arguments)}finally{m=O}}}})(vd);xd.exports=vd;var Qm=xd.exports;/**
 * @license React
...
<head>
    ...
    <style>
        * {
        ...
        /* Row heights of the two left-column tables are equalised in JS (see
           equalizeLeftColumnRowHeights). Once sized, stop the flex layout from stretching
           them again — otherwise whichever section has \`flex: 1\` re-absorbs the free space
           and its rows grow while the other stays compact. */
        .section-left-column.rows-equalized > .section,
        .section-left-column.rows-equalized .exercises-block,
        .section-left-column.rows-equalized .exercises-block table {
            flex: 0 0 auto;
        }
        .section-left-column.rows-equalized > .section {
            height: auto;
...
<body>
    ...
    <script>
        ...
        function setLanguage(lang) {
            ...
            // Switching language re-wraps the exercise names, so re-match the row heights.
            if (displayPage && displayPage.classList.contains('active')) {
                equalizeLeftColumnRowHeights();
            }
        }
        ...
        // "Upper body & neck" and "Stretching" share the left column but rarely hold the
        // same number of exercises, so the section with \`flex: 1\` used to absorb all the
        // free space (tall rows) while the other stayed compact. Give every row in BOTH
        // tables one shared height: split the column's free space across the TOTAL row
        // count, so the two tables line up row-for-row and the height still flexes with
        // how many exercises there are. Never goes below the tallest natural row, so a
        // wrapped exercise name can't get clipped.
        function equalizeLeftColumnRowHeights() {
            const col = document.querySelector('.section-left-column');
            if (!col) return;
            const bodies = ['upperBodyExercises', 'stretchingExercises']
                .map(id => document.getElementById(id))
                .filter(Boolean);
            if (bodies.length < 2) return;
            const rows = bodies.reduce((all, tb) => all.concat(Array.from(tb.rows)), []);
            if (!rows.length) return;
            const sections = Array.from(col.children).filter(el => el.classList.contains('section'));
            if (!sections.length) return;

            // Neutralise the flex stretching and any previous sizing, then measure natural sizes.
            col.classList.add('rows-equalized');
            rows.forEach(r => { r.style.height = ''; });

            const tallestRow = rows.reduce((m, r) => Math.max(m, r.getBoundingClientRect().height), 0);
            const sectionsHeight = sections.reduce((s, el) => s + el.getBoundingClientRect().height, 0);
            const rowsHeight = bodies.reduce((s, tb) => s + tb.getBoundingClientRect().height, 0);
            const chrome = sectionsHeight - rowsHeight;   // titles + table headers + padding
            const gap = (parseFloat(getComputedStyle(col).rowGap) || 0) * (sections.length - 1);

            const free = col.clientHeight - chrome - gap;
            const h = Math.max(tallestRow, free / rows.length);
        ...
        document.getElementById('assessmentForm').addEventListener('submit', async function(e) {
            ...
            // Match row heights across the two left-column tables (needs the page visible
            // so the column has a measurable height).
            equalizeLeftColumnRowHeights();
        ...
        function downloadPDF() {
            ...
            // Re-match row heights before measuring, so the page size reflects final layout.
            equalizeLeftColumnRowHeights();
