 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(A,L){var j=A.length;A.push(L);e:for(;0<j;){var O=j-1>>>1,H=A[O];if(0<a(H,L))A[O]=L,A[j]=H,j=O;else break e}}function t(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var L=A[0],j=A.pop();if(j!==L){A[0]=j;e:for(var O=0,H=A.length,he=H>>>1;O<he;){var X=2*(O+1)-1,Ne=A[X],un=X+1,We=A[un];if(0>a(Ne,j))un<H&&0>a(We,Ne)?(A[O]=We,A[un]=j,O=un):(A[O]=Ne,A[X]=j,O=X);else if(un<H&&0>a(We,j))A[O]=We,A[un]=j,O=un;else break e}}return L}function a(A,L){var j=A.sortIndex-L.sortIndex;return j!==0?j:A.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var s=[],c=[],u=1,f=null,g=3,y=!1,m=!1,x=!1,w=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(A){for(var L=t(c);L!==null;){if(L.callback===null)r(c);else if(L.startTime<=A)r(c),L.sortIndex=L.expirationTime,n(s,L);else break;L=t(c)}}function S(A){if(x=!1,v(A),!m)if(t(s)!==null)m=!0,G(R);else{var L=t(c);L!==null&&Me(S,L.startTime-A)}}function R(A,L){m=!1,x&&(x=!1,h(_),_=-1),y=!0;var j=g;try{for(v(L),f=t(s);f!==null&&(!(f.expirationTime>L)||A&&!V());){var O=f.callback;if(typeof O=="function"){f.callback=null,g=f.priorityLevel;var H=O(f.expirationTime<=L);L=e.unstable_now(),typeof H=="function"?f.callback=H:f===t(s)&&r(s),v(L)}else r(s);f=t(s)}if(f!==null)var he=!0;else{var X=t(c);X!==null&&Me(S,X.startTime-L),he=!1}return he}finally{f=null,g=j,y=!1}}var C=!1,E=null,_=-1,F=5,D=-1;function V(){return!(e.unstable_now()-D<F)}function ee(){if(E!==null){var A=e.unstable_now();D=A;var L=!0;try{L=E(!0,A)}finally{L?W():(C=!1,E=null)}}else C=!1}var W;if(typeof p=="function")W=function(){p(ee)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,ue=z.port2;z.port1.onmessage=ee,W=function(){ue.postMessage(null)}}else W=function(){w(ee,0)};function G(A){E=A,C||(C=!0,W())}function Me(A,L){_=w(function(){A(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(A){A.callback=null},e.unstable_continueExecution=function(){m||y||(m=!0,G(R))},e.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<A?Math.floor(1e3/A):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(A){switch(g){case 1:case 2:case 3:var L=3;break;default:L=g}var j=g;g=L;try{return A()}finally{g=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(A,L){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var j=g;g=A;try{return L()}finally{g=j}},e.unstable_scheduleCallback=function(A,L,j){var O=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?O+j:O):j=O,A){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=j+H,A={id:u++,callback:L,priorityLevel:A,startTime:j,expirationTime:H,sortIndex:-1},j>O?(A.sortIndex=j,n(c,A),t(s)===null&&A===t(c)&&(x?(h(_),_=-1):x=!0,Me(S,j-O))):(A.sortIndex=H,n(s,A),m||y||(m=!0,G(R))),A},e.unstable_shouldYield=V,e.unstable_wrapCallback=function(A){var L=g;return function(){var j=g;g=L;try{return A.apply(this,arguments)}finally{g=j}}}})(od);id.exports=od;var jm=id.exports;/**
 * @license React
...
`+i):r.stack=i}catch{}}throw r}}_request(n,t){typeof n=="string"?(t=t||{},t.url=n):t=n||{},t=ft(this.defaults,t);const{transitional:r,paramsSerializer:a,headers:i}=t;r!==void 0&&Ua.assertOptions(r,{silentJSONParsing:Ge.transitional(Ge.boolean),forcedJSONParsing:Ge.transitional(Ge.boolean),clarifyTimeoutError:Ge.transitional(Ge.boolean),legacyInterceptorReqResOrdering:Ge.transitional(Ge.boolean)},!1),a!=null&&(k.isFunction(a)?t.paramsSerializer={serialize:a}:Ua.assertOptions(a,{encode:Ge.function,serialize:Ge.function},!0)),t.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?t.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:t.allowAbsoluteUrls=!0),Ua.assertOptions(t,{baseUrl:Ge.spelling("baseURL"),withXsrfToken:Ge.spelling("withXSRFToken")},!0),t.method=(t.method||this.defaults.method||"get").toLowerCase();let o=i&&k.merge(i.common,i[t.method]);i&&k.forEach(["delete","get","head","post","put","patch","common"],m=>{delete i[m]}),t.headers=ze.concat(o,i);const l=[];let s=!0;this.interceptors.request.forEach(function(x){if(typeof x.runWhen=="function"&&x.runWhen(t)===!1)return;s=s&&x.synchronous;const w=t.transitional||Bs;w&&w.legacyInterceptorReqResOrdering?l.unshift(x.fulfilled,x.rejected):l.push(x.fulfilled,x.rejected)});const c=[];this.interceptors.response.forEach(function(x){c.push(x.fulfilled,x.rejected)});let u,f=0,g;if(!s){const m=[zu.bind(this),void 0];for(m.unshift(...l),m.push(...c),g=m.length,u=Promise.resolve(t);f<g;)u=u.then(m[f++],m[f++]);return u}g=l.length;let y=t;for(;f<g;){const m=l[f++],x=l[f++];try{y=m(y)}catch(w){x.call(this,w);break}}try{u=zu.call(this,y)}catch(m){return Promise.reject(m)}for(f=0,g=c.length;f<g;)u=u.then(c[f++],c[f++]);return u}getUri(n){n=ft(this.defaults,n);const t=qf(n.baseURL,n.url,n.allowAbsoluteUrls);return Uf(t,n.params,n.paramsSerializer)}};k.forEach(["delete","get","head","options"],function(n){lt.prototype[n]=function(t,r){return this.request(ft(r||{},{method:n,url:t,data:(r||{}).data}))}});k.forEach(["post","put","patch"],function(n){function t(r){return function(i,o,l){return this.request(ft(l||{},{method:n,headers:r?{"Content-Type":"multipart/form-data"}:{},url:i,data:o}))}}lt.prototype[n]=t(),lt.prototype[n+"Form"]=t(!0)});let v0=class Jf{constructor(n){if(typeof n!="function")throw new TypeError("executor must be a function.");let t;this.promise=new Promise(function(i){t=i});const r=this;this.promise.then(a=>{if(!r._listeners)return;let i=r._listeners.length;for(;i-- >0;)r._listeners[i](a);r._listeners=null}),this.promise.then=a=>{let i;const o=new Promise(l=>{r.subscribe(l),i=l}).then(a);return o.cancel=function(){r.unsubscribe(i)},o},n(function(i,o,l){r.reason||(r.reason=new ra(i,o,l),t(r.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(n){if(this.reason){n(this.reason);return}this._listeners?this._listeners.push(n):this._listeners=[n]}unsubscribe(n){if(!this._listeners)return;const t=this._listeners.indexOf(n);t!==-1&&this._listeners.splice(t,1)}toAbortSignal(){const n=new AbortController,t=r=>{n.abort(r)};return this.subscribe(t),n.signal.unsubscribe=()=>this.unsubscribe(t),n.signal}static source(){let n;return{token:new Jf(function(a){n=a}),cancel:n}}};function x0(e){return function(t){return e.apply(null,t)}}function y0(e){return k.isObject(e)&&e.isAxiosError===!0}const Bl={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries(Bl).forEach(([e,n])=>{Bl[n]=e});function Xf(e){const n=new lt(e),t=Nf(lt.prototype.request,n);return k.extend(t,lt.prototype,n,{allOwnKeys:!0}),k.extend(t,n,null,{allOwnKeys:!0}),t.create=function(a){return Xf(ft(e,a))},t}const ce=Xf(ta);ce.Axios=lt;ce.CanceledError=ra;ce.CancelToken=v0;ce.isCancel=Kf;ce.VERSION=Qf;ce.toFormData=Ui;ce.AxiosError=B;ce.Cancel=ce.CanceledError;ce.all=function(n){return Promise.all(n)};ce.spread=x0;ce.isAxiosError=y0;ce.mergeConfig=ft;ce.AxiosHeaders=ze;ce.formToJSON=e=>$f(k.isHTMLForm(e)?new FormData(e):e);ce.getAdapter=Yf.getAdapter;ce.HttpStatusCode=Bl;ce.default=ce;const{Axios:pw,AxiosError:fw,CanceledError:mw,isCancel:gw,CancelToken:hw,VERSION:vw,all:xw,Cancel:yw,isAxiosError:ww,spread:bw,toFormData:Sw,AxiosHeaders:kw,HttpStatusCode:Ew,formToJSON:_w,getAdapter:Rw,mergeConfig:Tw}=ce,Ae=ce.create({baseURL:"https://vald-automator-production.up.railway.app",timeout:3e4}),w0=(e,n)=>{const t=new FormData;return t.append("gym",e),t.append("file",n),Ae.post("/api/check",t,{timeout:9e4})},b0=(e,n,t)=>Ae.get("/api/trainer-whatsapp",{params:{gym:e,branch:n,trainer:t}}),S0=e=>Ae.post("/api/programs/approve",e),k0=e=>Ae.post("/api/programs/unapprove",e),E0=e=>Ae.post("/api/programs/ignore",e),_0=e=>Ae.post("/api/programs/unignore",e),Zf=e=>Ae.post("/api/programs/preview",e,{responseType:"text",timeout:6e4}),R0=e=>{const n=new FormData;return Object.entries(e).forEach(([t,r])=>r!=null&&n.append(t,r)),Ae.post("/api/report/generate",n,{responseType:"blob",timeout:12e4})},T0=(e,n)=>{const t=new FormData;return t.append("gym",e),t.append("file",n),Ae.post("/api/quick-generate",t,{timeout:9e4})},Hu=e=>Ae.get("/api/trainers/all",{params:{gym:e}}),L0=e=>Ae.post("/api/trainers",e),C0=(e,n)=>Ae.put(`/api/trainers/${e}`,n),A0=e=>Ae.delete(`/api/trainers/${e}`),N0=(e,n)=>{const t=new FormData;return t.append("month",e),t.append("year",n),Ae.post("/api/report/payment",t,{responseType:"blob",timeout:12e4})},P0=(e,n,t)=>{const r=new FormData;return r.append("gym",e),r.append("month",n),r.append("year",t),Ae.post("/api/report/growth",r,{responseType:"blob",timeout:12e4})},j0={"Body Masters":["RUH - Al Malaz","RUH - Al Massif","RUH - Al Aarid","RUH - Al Sahafa","RUH - Al Wadi","RUH - Eshbilia","RUH - Muzahmiyah","RUH - Rabwa","RUH - Salam","RUH - Swaidi","RUH - Takhasousi","RUH - Al Badia","RUH - Al Fayha","RUH - Al Khaleej","RUH - Al Kharj","RUH - Al Nahda","RUH - Badr","RUH - Ezdehar","RUH - Murooj","RUH - Shubra","DMM - Al Athir","DMM - Al Jameyeen","DMM - Hufof","DMM - Khobar","JED - Hamadania","JED - Al Rawdah","JED - Makkah","JED - Obhor - Al Amwaj","JED - Obhor - Al Sheraa","ALQ - Al Rass","ALQ - Al Rayyan","ALQ - Buraidah","ALQ - Unaizah","MED - Shouran","MED - Taiba","Uhud","AlUla","Al Mubaraz","Hafr El Batin","Tabuk","Najran","Khamis Mushait","Hail"],"Body Motions":["RUH - Al Malaz","RUH - Al Sahafa","RUH - Al Aarid","RUH - Al Fayha","RUH - Al Uraija","RUH - Badr","RUH - Al Badia","JED - Al Basateen","JED - Al Faisaliyah","JED - Al Naeem","JED - Obhor","DMM - Al Faisaliyah","DMM - Al Jalawiah","DMM - Al Nada","ALQ - Buraidah","ALQ - Unaizah","Al Ahsaa","AlUla","Tabuk"]},em=b.createContext(null);function D0({children:e}){const[n,t]=b.useState({}),[r,a]=b.useState(!1),i=b.useCallback(async g=>{if(!(!g||n[g])){a(!0);try{const y=await Hu(g);t(m=>({...m,[g]:y.data||{}}))}catch{}finally{a(!1)}}},[n]),o=b.useCallback(async g=>{if(g){a(!0);try{const y=await Hu(g);t(m=>({...m,[g]:y.data||{}}))}catch{}finally{a(!1)}}},[]),l=g=>Object.keys(n[g]||{}).sort((y,m)=>{const x=j0[g]||[],w=x.indexOf(y),h=x.indexOf(m);return w===-1&&h===-1?y.localeCompare(m):w===-1?1:h===-1?-1:w-h}),s=(g,y)=>{var m;return[...((m=n[g])==null?void 0:m[y])||[]].sort((x,w)=>x.name.localeCompare(w.name)).map(x=>x.name)},c=g=>Object.values(n[g]||{}).flat().map(y=>y.name).sort((y,m)=>y.localeCompare(m)),u=(g,y)=>{for(const[m,x]of Object.entries(n[g]||{}))if(x.some(w=>w.name===y))return m;return null},f=(g,y,m)=>{var x;return(((x=n[g])==null?void 0:x[y])||[]).find(w=>w.name===m)||null};return d.jsx(em.Provider,{value:{data:n,loading:r,load:i,reload:o,getBranches:l,getTrainers:s,getAllTrainers:c,getBranchForTrainer:u,getTrainerRecord:f},children:e})}function nm(){const e=b.useContext(em);if(!e)throw new Error("useTrainers must be used inside TrainersProvider");return e}const O0={upper:"Upper Body",lower:"Lower Body",full:"Full Body"},I0={NEW:"bg-emerald-900/60 text-emerald-300 border border-emerald-700",UPDATED:"bg-amber-900/60 text-amber-300 border border-amber-700"};function Uu({options:e,value:n,onChange:t,onSelect:r,placeholder:a,disabled:i,inputRef:o}){const[l,s]=b.useState(""),[c,u]=b.useState(!1),[f,g]=b.useState(0),y=b.useRef(null),m=b.useRef(null),x=l?e.filter(p=>p.toLowerCase().includes(l.toLowerCase())):e;b.useEffect(()=>{function p(v){y.current&&!y.current.contains(v.target)&&u(!1)}return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[]),b.useEffect(()=>{s(n||"")},[n]),b.useEffect(()=>{g(0)},[l]);function w(p){t(p),s(p),u(!1),r&&r(p)}function h(p){!c||x.length===0||(p.key==="ArrowDown"?(p.preventDefault(),g(v=>Math.min(v+1,x.length-1))):p.key==="ArrowUp"?(p.preventDefault(),g(v=>Math.max(v-1,0))):p.key==="Enter"?(p.preventDefault(),w(x[f])):p.key==="Escape"&&u(!1))}return b.useEffect(()=>{if(!m.current)return;const p=m.current.children[f];p&&p.scrollIntoView({block:"nearest"})},[f]),d.jsxs("div",{ref:y,className:"relative",children:[d.jsx("input",{ref:o,type:"text",className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-brand-500 disabled:opacity-50",placeholder:a,value:l,disabled:i,onChange:p=>{s(p.target.value),u(!0),p.target.value||t("")},onFocus:()=>u(!0),onKeyDown:h}),c&&!i&&x.length>0&&d.jsx("ul",{ref:m,className:"absolute z-50 mt-1 w-full bg-gray-800 border border-gray-700 rounded-lg shadow-lg max-h-48 overflow-y-auto",children:x.map((p,v)=>d.jsx("li",{onMouseDown:()=>w(p),onMouseEnter:()=>g(v),className:`px-3 py-2 text-sm cursor-pointer ${v===f?"bg-gray-700 text-white":p===n?"text-brand-400 font-semibold":"text-white"}`,children:p},p))})]})}function $u({test:e,gym:n}){const{getBranches:t,getTrainers:r,getAllTrainers:a,getBranchForTrainer:i,load:o}=nm(),[l,s]=b.useState(e.existing_branch||""),[c,u]=b.useState(e.existing_trainer_name||""),f=b.useRef(null),[g,y]=b.useState(e.existing_dispatch_date||new Date().toISOString().split("T")[0]);b.useEffect(()=>{o(n)},[n,o]);const[m,x]=b.useState(!1),[w,h]=b.useState(!1),[p,v]=b.useState(!1),[S,R]=b.useState(!1),[C,E]=b.useState(!1),[_,F]=b.useState(""),D=t(n),V=l?r(n,l):a(n);function ee(L){if(u(L),!l&&L){const j=i(n,L);j&&s(j)}}b.useEffect(()=>{n&&l&&c&&b0(n,l,c).then(L=>{var j;return F(((j=L.data)==null?void 0:j.whatsapp)||"")}).catch(()=>F(""))},[n,l,c]);const W=async()=>{var L,j;if(!e.cells_data){window.open(`https://vald-automator-production.up.railway.app/api/programs/preview-demo?gym=${encodeURIComponent(n)}&test_type=${e.test_type}`,"_blank");return}x(!0);try{const O=await Zf({gym:n,test_type:e.test_type,patient_name:e.patient,test_date:e.date,cells_data:e.cells_data,prev_asymmetries:e.prev_asymmetries||null}),H=new Blob([O.data],{type:"text/html"}),he=URL.createObjectURL(H),X=window.open(he,"_blank");X&&X.addEventListener("load",()=>X.print())}catch(O){alert("Failed to open program: "+(((j=(L=O.response)==null?void 0:L.data)==null?void 0:j.detail)||O.message))}finally{x(!1)}},z=async()=>{var j,O,H;if(!(e.status==="UPDATED"&&!l&&!c)&&(!l||!c)){alert("Please select a branch and trainer before approving.");return}v(!0);try{const X=(j=(await S0({gym:n,branch:l||e.existing_branch||"",client_id:e.external_id!=="N/A"?e.external_id:null,client_name:e.patient,test_type:e.test_type,movements:e.movement_count,test_date:e.date,trainer_name:c||e.existing_trainer_name||null,dispatch_date:g||e.existing_dispatch_date||null,check_status:e.status,asymmetry_values:e.asymmetry_values||null})).data)==null?void 0:j.id;h(!0)}catch(he){alert("Error approving: "+(((H=(O=he.response)==null?void 0:O.data)==null?void 0:H.detail)||he.message))}finally{v(!1)}},ue=async()=>{var L,j;E(!0);try{await E0({gym:n,client_name:e.patient,test_type:e.test_type,test_date:e.date,movements:e.movement_count,external_id:e.external_id!=="N/A"?e.external_id:null}),R(!0)}catch(O){alert("Error ignoring: "+(((j=(L=O.response)==null?void 0:L.data)==null?void 0:j.detail)||O.message))}finally{E(!1)}},G=async()=>{var L,j;try{await _0({gym:n,client_name:e.patient,test_type:e.test_type,test_date:e.date,movements:e.movement_count}),R(!1)}catch(O){alert("Error undoing ignore: "+(((j=(L=O.response)==null?void 0:L.data)==null?void 0:j.detail)||O.message))}},Me=async()=>{var L,j;try{await k0({gym:n,client_name:e.patient,test_type:e.test_type,test_date:e.date,movements:e.movement_count}),h(!1)}catch(O){alert("Error undoing approval: "+(((j=(L=O.response)==null?void 0:L.data)==null?void 0:j.detail)||O.message))}},A=()=>{if(!_){alert("No WhatsApp number set for this trainer.");return}const L=_.replace(/\D/g,"");window.open(`https://wa.me/${L}`,"_blank")};return d.jsxs("div",{className:`rounded-xl border p-5 space-y-4 transition-all
      ${w?"border-emerald-700 bg-emerald-950/20":S?"border-red-900 bg-red-950/20":"border-gray-700 bg-gray-900"}`,children:[d.jsxs("div",{className:"flex flex-wrap items-start justify-between gap-2",children:[d.jsxs("div",{children:[d.jsxs("div",{className:"flex items-center gap-2 flex-wrap",children:[d.jsx("span",{className:`text-xs font-semibold px-2 py-0.5 rounded-full ${I0[e.status]}`,children:e.status}),d.jsx("h3",{className:"font-semibold text-white",children:e.patient}),e.external_id&&e.external_id!=="N/A"&&d.jsxs("span",{className:"text-xs text-gray-400 font-mono",children:["#",e.external_id]})]}),d.jsxs("div",{className:"mt-1 flex flex-wrap gap-3 text-sm text-gray-400",children:[d.jsx("span",{children:O0[e.test_type]||e.test_type}),d.jsx("span",{children:"·"}),d.jsxs("span",{children:[e.movement_count," movements"]}),d.jsx("span",{children:"·"}),d.jsx("span",{children:e.date}),e.status==="UPDATED"&&d.jsxs("span",{className:"text-amber-400",children:["(was ",e.old_count,")"]})]})]}),d.jsx("button",{onClick:()=>navigator.clipboard.writeText(e.patient),title:"Copy client name",className:"text-gray-600 hover:text-gray-300 transition-colors p-1 rounded",children:d.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"w-4 h-4",children:[d.jsx("rect",{x:"9",y:"9",width:"13",height:"13",rx:"2",ry:"2"}),d.jsx("path",{d:"M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"})]})})]}),d.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-3 gap-3",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-xs text-gray-400 mb-1",children:"Branch"}),d.jsx(Uu,{options:D,value:l,onChange:L=>{s(L),u("")},onSelect:()=>{f.current&&f.current.focus()},placeholder:"Search branch…",disabled:w||S})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-xs text-gray-400 mb-1",children:"Trainer"}),d.jsx(Uu,{options:V,value:c,onChange:ee,placeholder:"Search trainer…",disabled:w||S,inputRef:f})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-xs text-gray-400 mb-1",children:"Dispatch Date"}),d.jsx("input",{type:"date",className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-brand-500",value:g,onChange:L=>y(L.target.value),disabled:w||S})]})]}),d.jsxs("div",{className:"flex flex-wrap gap-2 items-center",children:[d.jsx("button",{onClick:W,disabled:m,className:"text-xs px-3 py-1.5 rounded-lg border border-gray-600 text-gray-400 hover:border-gray-300 hover:text-gray-200 disabled:opacity-50 transition-colors",children:m?"Loading…":"🖨 Open & Print"}),d.jsx("button",{onClick:()=>{const L={upper:"Upper Body",lower:"Lower Body",full:"Full Body"}[e.test_type]||e.test_type;navigator.clipboard.writeText(`${e.patient} - ${L}`)},className:"text-xs px-3 py-1.5 rounded-lg border border-gray-600 text-gray-400 hover:border-gray-300 hover:text-gray-200 transition-colors",children:"📋 Copy File Name"}),!w&&!S&&d.jsx("button",{onClick:ue,disabled:C,className:"text-xs px-3 py-1.5 rounded-lg border border-gray-700 text-gray-500 hover:border-red-700 hover:text-red-400 disabled:opacity-50 transition-colors",children:C?"Ignoring…":"Ignore"}),d.jsx("div",{className:"flex-1"}),d.jsxs("button",{onClick:A,disabled:!_,title:_?"":"No WhatsApp number for this trainer",className:"flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-green-700 hover:bg-green-600 text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-green-700",children:[d.jsx("svg",{viewBox:"0 0 24 24",className:"w-3.5 h-3.5 fill-current",children:d.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"})}),"WhatsApp"]}),w?d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx("span",{className:"text-xs px-4 py-1.5 rounded-lg bg-emerald-700/40 text-emerald-400 font-semibold border border-emerald-700",children:"✓ Approved"}),d.jsx("button",{onClick:Me,className:"text-xs px-3 py-1.5 rounded-lg border border-gray-700 text-gray-400 hover:border-gray-400 hover:text-gray-200 transition-colors",children:"Undo"})]}):S?d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx("span",{className:"text-xs px-4 py-1.5 rounded-lg bg-red-900/40 text-red-400 font-semibold border border-red-800",children:"✗ Ignored"}),d.jsx("button",{onClick:G,className:"text-xs px-3 py-1.5 rounded-lg border border-gray-700 text-gray-400 hover:border-gray-400 hover:text-gray-200 transition-colors",children:"Undo"})]}):d.jsx("button",{onClick:z,disabled:p,className:"text-xs px-4 py-1.5 rounded-lg bg-brand-600 hover:bg-brand-500 disabled:opacity-50 text-white font-semibold transition-colors",children:p?"Saving…":"Approve"})]})]})}const F0=[{name:"Body Motions",logo:"/VALD-automator/Motions_logo.png"},{name:"Body Masters",logo:"/VALD-automator/Masters_logo.png"}];function B0(){const[e,n]=b.useState("Body Motions"),[t,r]=b.useState(!1),[a,i]=b.useState(null),[o,l]=b.useState(null),[s,c]=b.useState("desc"),u=async m=>{var x,w;r(!0),i(null),l(null);try{const h=await w0(e,m);l(h.data)}catch(h){i(((w=(x=h.response)==null?void 0:x.data)==null?void 0:w.detail)||h.message||"Failed to process file")}finally{r(!1)}},f=o?[...o].sort((m,x)=>{const w=new Date(m.date)-new Date(x.date);return s==="asc"?w:-w}):[],g=f.filter(m=>m.status==="NEW"),y=f.filter(m=>m.status==="UPDATED");return d.jsxs("div",{className:"max-w-5xl mx-auto space-y-6",children:[d.jsx("h1",{className:"text-2xl font-bold text-white",children:"Program Generation"}),d.jsx("div",{className:"flex gap-3",children:F0.map(m=>d.jsx("button",{onClick:()=>{n(m.name),l(null)},className:`rounded-xl overflow-hidden transition-all border-2 bg-gray-100
              ${e===m.name?"border-brand-500 shadow-lg shadow-brand-500/30 scale-105":"border-transparent opacity-60 hover:opacity-90 hover:border-gray-500"}`,children:d.jsx("img",{src:m.logo,alt:m.name,className:"h-14 w-auto object-contain px-3 py-1.5"})},m.name))}),d.jsx(Hx,{onFile:u,loading:t}),a&&d.jsx("div",{className:"rounded-lg bg-red-900/40 border border-red-700 text-red-300 px-4 py-3 text-sm",children:a}),o!==null&&d.jsxs("div",{className:"space-y-8",children:[d.jsxs("div",{className:"flex items-center gap-4 text-sm flex-wrap",children:[d.jsxs("span",{className:"text-gray-300",children:[d.jsx("span",{className:"font-bold text-emerald-400",children:g.length})," new"]}),d.jsx("span",{className:"text-gray-600",children:"|"}),d.jsxs("span",{className:"text-gray-300",children:[d.jsx("span",{className:"font-bold text-amber-400",children:y.length})," updated"]}),o.length===0&&d.jsx("span",{className:"text-gray-500",children:"No new or updated tests found."}),d.jsxs("div",{className:"ml-auto flex gap-1",children:[d.jsx("button",{onClick:()=>c("desc"),className:`px-3 py-1 rounded-lg text-xs font-medium border transition-all ${s==="desc"?"bg-brand-600 border-brand-500 text-white":"bg-gray-800 border-gray-700 text-gray-400 hover:border-gray-500"}`,children:"Newest first"}),d.jsx("button",{onClick:()=>c("asc"),className:`px-3 py-1 rounded-lg text-xs font-medium border transition-all ${s==="asc"?"bg-brand-600 border-brand-500 text-white":"bg-gray-800 border-gray-700 text-gray-400 hover:border-gray-500"}`,children:"Oldest first"})]})]}),g.length>0&&d.jsxs("section",{className:"space-y-3",children:[d.jsxs("h2",{className:"text-lg font-semibold text-emerald-400 border-b border-emerald-900 pb-1",children:["New Tests (",g.length,")"]}),g.map((m,x)=>d.jsx($u,{test:m,gym:e},`new-${x}`))]}),y.length>0&&d.jsxs("section",{className:"space-y-3",children:[d.jsxs("h2",{className:"text-lg font-semibold text-amber-400 border-b border-amber-900 pb-1",children:["Updated Tests (",y.length,")"]}),y.map((m,x)=>d.jsx($u,{test:m,gym:e},`upd-${x}`))]})]})]})}const tm=[{name:"Body Motions",logo:"/VALD-automator/Motions_logo.png"},{name:"Body Masters",logo:"/VALD-automator/Masters_logo.png"}],Pe=["January","February","March","April","May","June","July","August","September","October","November","December"];function z0(e,n){const t=new Date(e,n-1,1).getDay(),r=new Date(e,n,0).getDate();return Math.ceil((t+r)/7)}function M0(){const e=new Date,[n,t]=b.useState("Body Motions"),[r,a]=b.useState("monthly"),[i,o]=b.useState(e.getFullYear()),[l,s]=b.useState(e.getMonth()+1),[c,u]=b.useState(1),[f,g]=b.useState(null),[y,m]=b.useState(null),[x,w]=b.useState(!1),[h,p]=b.useState(null),v=new Date(i,l,0).getDate(),S=z0(i,l),R=(()=>{const E=e.getFullYear(),_=e.getMonth()+1;return i>E?!0:i<E?!1:l>_?!0:l<_?!1:r==="weekly"?(c-1)*7+1>e.getDate():r==="custom"&&f?f>e.getDate():!1})(),C=async()=>{var E,_,F;w(!0),p(null);try{const V=await R0({gym:n,period_type:r==="custom"?"monthly":r,year:i,month:l,week_number:r==="weekly"?c:null,start_day:r==="custom"&&f?f:null,end_day:r==="custom"&&y?y:null}),ee=new Blob([V.data],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),W=URL.createObjectURL(ee),z=document.createElement("a"),G=(((E=V.headers)==null?void 0:E["content-disposition"])||"").match(/filename="([^"]+)"/),Me=r==="custom"?`${Pe[l-1]} ${i} (Day ${f||1}–${y||v})`:r==="monthly"?`${Pe[l-1]} ${i}`:`Week ${c} - ${Pe[l-1]} ${i}`;z.href=W,z.download=G?G[1]:`${Me} - ${n}.xlsx`,z.click(),URL.revokeObjectURL(W)}catch(D){p(((F=(_=D.response)==null?void 0:_.data)==null?void 0:F.detail)||D.message||"Failed to generate report")}finally{w(!1)}};return d.jsxs("div",{className:"max-w-5xl mx-auto space-y-6",children:[d.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-[1fr_1px_1fr] gap-8",children:[d.jsx("h1",{className:"text-2xl font-bold text-white",children:"Reports"}),d.jsx("div",{}),d.jsx("h1",{className:"text-2xl font-bold text-white hidden lg:block",children:"Payment Report"})]}),d.jsxs("div",{className:"grid grid-cols-1 lg:grid-cols-[1fr_1px_1fr] gap-8 items-start",children:[d.jsxs("div",{className:"space-y-6",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"Gym"}),d.jsx("div",{className:"flex gap-3",children:tm.map(E=>d.jsx("button",{onClick:()=>t(E.name),className:`rounded-xl overflow-hidden transition-all border-2 bg-gray-100
                ...
                ${r===E?"bg-brand-600 text-white":"bg-gray-800 text-gray-400 hover:text-white hover:bg-gray-700"}`,children:E},E))})]}),d.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Month"}),d.jsx("select",{value:l,onChange:E=>s(Number(E.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:Pe.map((E,_)=>d.jsx("option",{value:_+1,children:E},_+1))})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Year"}),d.jsx("select",{value:i,onChange:E=>o(Number(E.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:[e.getFullYear()-1,e.getFullYear(),e.getFullYear()+1].map(E=>d.jsx("option",{value:E,children:E},E))})]})]}),r==="custom"&&d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"Date Range"}),d.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"Start Day"}),d.jsxs("select",{value:f||"",onChange:E=>g(E.target.value?Number(E.target.value):null),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:[d.jsx("option",{value:"",children:"—"}),Array.from({length:v},(E,_)=>_+1).map(E=>d.jsx("option",{value:E,children:E},E))]})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-xs text-gray-500 mb-1",children:"End Day"}),d.jsxs("select",{value:y||"",onChange:E=>m(E.target.value?Number(E.target.value):null),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:[d.jsx("option",{value:"",children:"—"}),Array.from({length:v},(E,_)=>_+1).map(E=>d.jsx("option",{value:E,children:E},E))]})]})]})]}),r==="weekly"&&d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"Week"}),d.jsx("div",{className:"flex gap-2 flex-wrap",children:Array.from({length:S},(E,_)=>_+1).map(E=>d.jsxs("button",{onClick:()=>u(E),className:`w-12 h-10 rounded-lg text-sm font-semibold transition-colors
                  ${c===E?"bg-brand-600 text-white":"bg-gray-800 text-gray-400 hover:text-white hover:bg-gray-700"}`,children:["W",E]},E))}),d.jsxs("p",{className:"text-xs text-gray-500 mt-1",children:["Week ",c,": days ",(c-1)*7+1,"–",Math.min(c*7,new Date(i,l,0).getDate())]})]}),h&&d.jsx("div",{className:"rounded-lg bg-red-900/40 border border-red-700 text-red-300 px-4 py-3 text-sm",children:h}),d.jsx("button",{onClick:C,disabled:x||R,className:"w-full py-3 rounded-xl bg-brand-600 hover:bg-brand-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm transition-colors",children:x?"Generating…":"Generate & Download Report"}),R&&d.jsx("p",{className:"text-xs text-amber-500 text-center",children:"Cannot generate a report for a future period."}),d.jsxs("p",{className:"text-xs text-gray-500 text-center",children:["Report pulls all ",d.jsx("strong",{className:"text-gray-400",children:"approved"})," programs",r==="weekly"?` dispatched in week ${c} of ${Pe[l-1]} ${i}`:r==="custom"?` dispatched between day ${f||1} and day ${y||v} of ${Pe[l-1]} ${i}`:` dispatched in ${Pe[l-1]} ${i}`,"."]})]}),d.jsx("div",{className:"hidden lg:block bg-gray-700 self-stretch"}),d.jsx("div",{className:"space-y-6",children:d.jsx(U0,{})})]}),d.jsx("div",{className:"border-t border-gray-700 pt-6",children:d.jsx(H0,{})})]})}function H0(){const e=new Date,[n,t]=b.useState("Body Motions"),[r,a]=b.useState(e.getMonth()+1),[i,o]=b.useState(e.getFullYear()),[l,s]=b.useState(!1),[c,u]=b.useState(null),f=`${Pe[(r-2+12)%12]} ${r===1?i-1:i}`,g=async()=>{var y,m,x;s(!0),u(null);try{const w=await P0(n,r,i),h=new Blob([w.data],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),p=URL.createObjectURL(h),v=document.createElement("a"),R=(((y=w.headers)==null?void 0:y["content-disposition"])||"").match(/filename="([^"]+)"/);v.href=p,v.download=R?R[1]:`Test Growth Tracker - ${n} - ${Pe[r-1]} ${i}.xlsx`,v.click(),URL.revokeObjectURL(p)}catch(w){u(((x=(m=w.response)==null?void 0:m.data)==null?void 0:x.detail)||w.message||"Failed to generate growth tracker")}finally{s(!1)}};return d.jsxs("div",{className:"max-w-2xl space-y-5",children:[d.jsx("div",{children:d.jsx("h1",{className:"text-2xl font-bold text-white",children:"Test Growth Tracker"})}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-2",children:"Gym"}),d.jsx("div",{className:"flex gap-3",children:tm.map(y=>d.jsx("button",{onClick:()=>t(y.name),className:`rounded-xl overflow-hidden transition-all border-2 bg-gray-100
                ${n===y.name?"border-brand-500 shadow-lg shadow-brand-500/30 scale-105":"border-transparent opacity-60 hover:opacity-90 hover:border-gray-500"}`,children:d.jsx("img",{src:y.logo,alt:y.name,className:"h-14 w-auto object-contain px-3 py-1.5"})},y.name))})]}),d.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Month"}),d.jsx("select",{value:r,onChange:y=>a(Number(y.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:Pe.map((y,m)=>d.jsx("option",{value:m+1,children:y},m+1))})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Year"}),d.jsx("select",{value:i,onChange:y=>o(Number(y.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:[e.getFullYear()-1,e.getFullYear(),e.getFullYear()+1].map(y=>d.jsx("option",{value:y,children:y},y))})]})]}),c&&d.jsx("div",{className:"rounded-lg bg-red-900/40 border border-red-700 text-red-300 px-4 py-3 text-sm",children:c}),d.jsx("button",{onClick:g,disabled:l,className:"w-full py-3 rounded-xl bg-brand-600 hover:bg-brand-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm transition-colors",children:l?"Generating…":"Generate & Download Growth Tracker"}),d.jsxs("p",{className:"text-xs text-gray-500 text-center",children:["Compares ",d.jsxs("strong",{className:"text-gray-400",children:[Pe[r-1]," ",i]})," vs"," ",d.jsx("strong",{className:"text-gray-400",children:f})," test counts per branch and trainer."]})]})}function U0(){const e=new Date,[n,t]=b.useState(e.getMonth()+1),[r,a]=b.useState(e.getFullYear()),[i,o]=b.useState(!1),[l,s]=b.useState(null),c=async()=>{var u,f,g;o(!0),s(null);try{const y=await N0(n,r),m=new Blob([y.data],{type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}),x=URL.createObjectURL(m),w=document.createElement("a"),p=(((u=y.headers)==null?void 0:u["content-disposition"])||"").match(/filename="([^"]+)"/);w.href=x,w.download=p?p[1]:`Payment - ${Pe[n-1]} ${r}.xlsx`,w.click(),URL.revokeObjectURL(x)}catch(y){s(((g=(f=y.response)==null?void 0:f.data)==null?void 0:g.detail)||y.message||"Failed to generate payment report")}finally{o(!1)}};return d.jsxs("div",{className:"space-y-5",children:[d.jsx("h1",{className:"text-2xl font-bold text-white lg:hidden",children:"Payment Report"}),d.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Month"}),d.jsx("select",{value:n,onChange:u=>t(Number(u.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:Pe.map((u,f)=>d.jsx("option",{value:f+1,children:u},f+1))})]}),d.jsxs("div",{children:[d.jsx("label",{className:"block text-sm text-gray-400 mb-1",children:"Year"}),d.jsx("select",{value:r,onChange:u=>a(Number(u.target.value)),className:"w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-1 focus:ring-brand-500",children:[e.getFullYear()-1,e.getFullYear(),e.getFullYear()+1].map(u=>d.jsx("option",{value:u,children:u},u))})]})]}),l&&d.jsx("div",{className:"rounded-lg bg-red-900/40 border border-red-700 text-red-300 px-4 py-3 text-sm",children:l}),d.jsx("button",{onClick:c,disabled:i,className:"w-full py-3 rounded-xl bg-brand-600 hover:bg-brand-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-sm transition-colors",children:i?"Generating…":"Generate & Download Payment Report"}),d.jsxs("p",{className:"text-xs text-gray-500 text-center",children:["Appends all programs from ",d.jsx("strong",{className:"text-gray-400",children:"May 2026"})," through ",d.jsxs("strong",{className:"text-gray-400",children:[Pe[n-1]," ",r]})," to the payment report."]})]})}const $0=[{name:"Body Motions",logo:"/VALD-automator/Motions_logo.png"},{name:"Body Masters",logo:"/VALD-automator/Masters_logo.png"}],K0={upper:"Upper Body",lower:"Lower Body",full:"Full Body"};function V0({item:e,gym:n}){const[t,r]=b.useState(!1),a=async()=>{var i,o;r(!0);try{const l=await Zf({gym:n,test_type:e.test_type,patient_name:e.patient,test_date:e.date,cells_data:e.cells_data,prev_asymmetries:null}),s=new Blob([l.data],{type:"text/html"}),c=URL.createObjectURL(s),u=window.open(c,"_blank");u&&u.addEventListener("load",()=>u.print())}catch(l){alert("Failed to open program: "+(((o=(i=l.response)==null?void 0:i.data)==null?void 0:o.detail)||l.message))}finally{r(!1)}};return d.jsxs("div",{className:"rounded-xl border border-gray-700 bg-gray-900 px-5 py-4 flex items-center justify-between gap-4",children:[d.jsxs("div",{children:[d.jsx("p",{className:"font-semibold text-white",children:e.patient}),d.jsxs("p",{className:"text-sm text-gray-400 mt-0.5",children:[K0[e.test_type]||e.test_type,d.jsx("span",{className:"mx-1.5 text-gray-600",children:"·"}),e.movement_count," movements",d.jsx("span",{className:"mx-1.5 text-gray-600",children:"·"}),e.date]})]}),d.jsx("button",{onClick:a,disabled:t,className:"shrink-0 text-xs px-3 py-1.5 rounded-lg border border-gray-600 text-gray-400 hover:border-gray-300 hover:text-gray-200 disabled:opacity-50 transition-colors",children:t?"Loading…":"🖨 Open & Print"})]})}function q0(){const[e,n]=b.useState("Body Motions"),[t,r]=b.useState(!1),[a,i]=b.useState(null),[o,l]=b.useState(null),s=async g=>{var y,m;if(g.length){r(!0),i(null),l(null);try{const x=await T0(e,g[0]);l(x.data)}catch(x){i(((m=(y=x.response)==null?void 0:y.data)==null?void 0:m.detail)||x.message||"Failed to process file")}finally{r(!1)}}},{getRootProps:c,getInputProps:u,isDragActive:f}=Os({onDrop:s,accept:{"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet":[".xlsx"],"application/vnd.ms-excel.sheet.macroEnabled.12":[".xlsm"],"application/vnd.ms-excel":[".xls"]},multiple:!1,disabled:t});return d.jsxs("div",{className:"max-w-5xl mx-auto space-y-6",children:[d.jsx("h1",{className:"text-2xl font-bold text-white",children:"Quick Generate"}),d.jsx("div",{className:"flex gap-3",children:$0.map(g=>d.jsx("button",{onClick:()=>{n(g.name),l(null)},className:`rounded-xl overflow-hidden transition-all border-2 bg-gray-100
...
</html>`,nw=`${window.location.origin}/VALD-automator/bodydot/`,St=25,tw=4;function im(e){return(e||"").normalize("NFKD").replace(new RegExp("\\p{M}","gu"),"").toLowerCase().replace(/\s+/g," ").trim()}function rw(e,n){const t=im(e);return n.every(r=>t.includes(r))}function aw(e){const n=new Date(e);return isNaN(n)?null:n.toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"})}function iw(e,n,t){const r={session:e,clientName:n,lang:t?"bilingual":"en",autoPrint:!0},a='<meta charset="UTF-8">',i=`<base href="${nw}"><script>window.__BODYDOT__ = ${JSON.stringify(r)};<\/script>`,o=ew.replace(a,`${a}${i}`),l=new Blob([o],{type:"text/html"}),s=URL.createObjectURL(l);if(!window.open(s,"_blank"))throw URL.revokeObjectURL(s),new Error("Popup blocked — allow popups for this site and try again.");setTimeout(()=>URL.revokeObjectURL(s),6e4)}function ow({client:e,bilingual:n,dateInfo:t}){const[r,a]=b.useState(!1),i=async()=>{a(!0);try{const l=await am(e.id);iw(l,e.name||"",n)}catch(l){alert(`Could not generate program for ${e.name||"client"}: ${l.message}`)}finally{a(!1)}};let o;return t===void 0?o=d.jsx("span",{className:"text-gray-600",children:"Loading test date…"}):t===null?o=d.jsx("span",{className:"text-gray-600",children:"No test data"}):o=d.jsxs("span",{className:"text-gray-400",children:["Test date: ",t]}),d.jsxs("div",{className:"flex items-center justify-between gap-4 px-5 py-3 border-b border-gray-800 last:border-b-0",children:[d.jsxs("div",{children:[d.jsx("p",{className:"font-medium text-white",children:e.name||"—"}),d.jsx("p",{className:"text-xs mt-0.5",children:o})]}),d.jsx("button",{onClick:i,disabled:r,className:"shrink-0 text-xs px-3 py-1.5 rounded-lg bg-brand-600 text-white hover:bg-brand-500 disabled:opacity-50 transition-colors font-semibold",children:r?"Loading…":"Generate Program"})]})}function lw(){const[e,n]=b.useState(null),[t,r]=b.useState([]),[a,i]=b.useState(!1),[o,l]=b.useState(null),[s,c]=b.useState(""),[u,f]=b.useState(0),[g,y]=b.useState({}),m=b.useRef(0),x=Ku.find(_=>_.id===e),w=async _=>{n(_.id),c(""),f(0),l(null),r([]),y({}),i(!0);try{r(await Z0(_.id))}catch(F){l(`Error loading clients: ${F.message}`)}finally{i(!1)}},h=im(s).split(" ").filter(Boolean),p=h.length?t.filter(_=>rw(_.name,h)):t,v=Math.max(1,Math.ceil(p.length/St)),S=Math.min(u,v-1),R=p.slice(S*St,S*St+St),C=R.map(_=>_.id).join(",");b.useEffect(()=>{if(!R.length)return;const _=++m.current,F=R.filter(ee=>g[ee.id]===void 0);if(!F.length)return;let D=0;const V=async()=>{for(;D<F.length;){if(_!==m.current)return;const ee=F[D++];let W=null;try{const z=await am(ee.id);W=aw(z.createdAt)||null}catch{W=null}if(_!==m.current)return;y(z=>({...z,[ee.id]:W}))}};Promise.all(Array.from({length:Math.min(tw,F.length)},V))},[C]);const E=_=>{c(_),f(0)};return d.jsxs("div",{className:"max-w-3xl mx-auto space-y-6",children:[d.jsxs("div",{children:[d.jsx("h1",{className:"text-2xl font-bold text-white",children:"Bodydot"}),d.jsx("p",{className:"text-gray-400 text-sm mt-1",children:"Select a center to view clients."})]}),d.jsx("div",{className:"flex flex-wrap gap-3",children:Ku.map(_=>d.jsx("button",{onClick:()=>w(_),className:`flex-1 min-w-[200px] text-left rounded-xl border-2 px-5 py-4 transition-colors
              ${e===_.id?"border-brand-500 bg-brand-900/20":"border-gray-700 bg-gray-900 hover:border-gray-500"}`,children:d.jsx("div",{className:"font-semibold text-white",children:_.name})},_.id))}),o&&d.jsx("div",{className:"rounded-lg bg-red-900/40 border border-red-700 text-red-300 px-4 py-3 text-sm",children:o}),e&&d.jsxs("div",{className:"space-y-3",children:[d.jsxs("div",{className:"flex items-center justify-between gap-3",children:[d.jsx("h2",{className:"text-lg font-semibold text-white",children:x==null?void 0:x.name}),d.jsx("input",{type:"text",value:s,onChange:_=>E(_.target.value),placeholder:"Search clients…",className:"px-3 py-1.5 rounded-lg bg-gray-800 border border-gray-700 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-brand-500 max-w-xs"})]}),a?d.jsx("p",{className:"text-gray-400 text-sm py-4",children:"Loading clients…"}):p.length===0?d.jsx("p",{className:"text-gray-500 text-sm py-4",children:t.length===0?"No clients found.":"No clients match your search."}):d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"rounded-xl border border-gray-800 bg-gray-900 overflow-hidden",children:R.map(_=>d.jsx(ow,{client:_,bilingual:x==null?void 0:x.bilingual,dateInfo:g[_.id]},_.id))}),d.jsxs("div",{className:"flex items-center justify-between text-sm text-gray-400",children:[d.jsxs("span",{children:[S*St+1,"–",S*St+R.length," of"," ",p.length]}),v>1&&d.jsxs("div",{className:"flex items-center gap-2",children:[d.jsx("button",{onClick:()=>f(_=>Math.max(0,_-1)),disabled:S===0,className:"px-3 py-1.5 rounded-lg border border-gray-700 hover:border-gray-500 disabled:opacity-40 disabled:hover:border-gray-700 transition-colors",children:"← Prev"}),d.jsxs("span",{className:"text-gray-500",children:["Page ",S+1," of ",v]}),d.jsx("button",{onClick:()=>f(_=>Math.min(v-1,_+1)),disabled:S>=v-1,className:"px-3 py-1.5 rounded-lg border border-gray-700 hover:border-gray-500 disabled:opacity-40 disabled:hover:border-gray-700 transition-colors",children:"Next →"})]})]})]})]})]})}function sw(){return d.jsx(D0,{children:d.jsxs("div",{className:"min-h-screen flex flex-col bg-gray-900",children:[d.jsxs("nav",{className:"bg-gray-900 border-b border-gray-800 px-6 py-2 flex items-center",children:[d.jsx("div",{className:"flex items-center justify-center mr-12 h-[90px] w-[85px]",children:d.jsx("img",{src:"/VALD-automator/FIT_LOGO.png",alt:"Fit Logo",className:"h-[49px] w-auto object-contain translate-x-[6px]"})}),d.jsxs("div",{className:"flex gap-1",children:[d.jsx(ur,{to:"/",end:!0,className:({isActive:e})=>`px-4 py-2 rounded-md text-sm font-medium transition-colors ${e?"bg-brand-600 text-white":"text-gray-400 hover:text-white hover:bg-gray-700"}`,children:"VALD Generation"}),d.jsx(ur,{to:"/bodydot",className:({isActive:e})=>`px-4 py-2 rounded-md text-sm font-medium transition-colors ${e?"bg-brand-600 text-white":"text-gray-400 hover:text-white hover:bg-gray-700"}`,children:"Bodydot Generation"}),d.jsx(ur,{to:"/reports",className:({isActive:e})=>`px-4 py-2 rounded-md text-sm font-medium transition-colors ${e?"bg-brand-600 text-white":"text-gray-400 hover:text-white hover:bg-gray-700"}`,children:"Reports"})]}),d.jsx("div",{className:"flex-1"}),d.jsx("div",{className:"w-px h-6 bg-gray-700 mx-4"}),d.jsxs("div",{className:"flex gap-1",children:[d.jsx(ur,{to:"/quick",className:({isActive:e})=>`px-4 py-2 rounded-md text-sm font-medium transition-colors ${e?"border border-brand-500 text-brand-300 bg-brand-950/40":"text-gray-500 hover:text-gray-300 hover:bg-gray-800 border border-transparent"}`,children:"Quick Generate"}),d.jsx(ur,{to:"/trainers",className:({isActive:e})=>`px-4 py-2 rounded-md text-sm font-medium transition-colors ${e?"border border-brand-500 text-brand-300 bg-brand-950/40":"text-gray-500 hover:text-gray-300 hover:bg-gray-800 border border-transparent"}`,children:"Trainers"})]})]}),d.jsx("main",{className:"flex-1 p-6",children:d.jsxs(Lv,{children:[d.jsx(kt,{path:"/",element:d.jsx(B0,{})}),d.jsx(kt,{path:"/reports",element:d.jsx(M0,{})}),d.jsx(kt,{path:"/quick",element:d.jsx(q0,{})}),d.jsx(kt,{path:"/trainers",element:d.jsx(Q0,{})}),d.jsx(kt,{path:"/bodydot",element:d.jsx(lw,{})})]})})]})})}jo.createRoot(document.getElementById("root")).render(d.jsx($l.StrictMode,{children:d.jsx(Iv,{children:d.jsx(sw,{})})}));
