...
const TRAINERS = {
  "Body Motions": {
    ...
    "RUH - Al Aarid": ["Maryam Al-Qawsari","Shaden Omar","Hidaya Moubarak","Safa Al Saggadi","Malak Al Zahabi","Chaza Ben Miled","Nada Mohamed Khalifa","Warda Al Hajji","Amal Al Chiboub"],
    ...
    "RUH - Al Badia": ["Rajae Al-Jabouji","Maram Farhawi","Safa Radif","Nermin Hadi Debaya","Hasna AlKayyal","Takwa Abdelly","Nawres Khordeni"],
    "JED - Al Basateen": ["Iman Kouisseh","Raghad Al Bir Qaddar","Ranim Brahmi","Sabrine Al Amine","Mouna Farhat","Salwa Mlaiki","Reyouf Saad","Shurooq Amer","Maha Fayez Al Ahmari","Salma Jadli"],
